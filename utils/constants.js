...
export const ALLOWED_TRANSITIONS = {
    ...
    [ORDER_STATUSES.CONFIRMED]: [ORDER_STATUSES.PRODUCTION, ORDER_STATUSES.PACKING],
    [ORDER_STATUSES.PRODUCTION]: [ORDER_STATUSES.PACKING],
    [ORDER_STATUSES.PACKING]: [ORDER_STATUSES.INVOICE],
